...
parser.add_argument("--save", action="store_true", default=False, help="Save the data from camera")
parser.add_argument(
    "--camera_id",
    type=int,
    choices={0, 1, 2, 3},
...
from omni.isaac.orbit.utils import configclass, convert_dict_to_backend
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene):
    ...
    while simulation_app.is_running():
        ...
        if args_cli.save:
            single_cam_data = convert_dict_to_backend(scene["camera"].data.output[camera_index], backend="numpy")
            single_cam_info = scene["camera"].data.info[camera_index]
            rep_output = dict()
